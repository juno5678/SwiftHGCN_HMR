...
from src.modeling.backbone.config.config import cfg, update_config, init_experiment_dir
...
class HRNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.backbone_channels = num_channels[0]
