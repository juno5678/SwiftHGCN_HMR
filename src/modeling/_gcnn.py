...
class GraphResBlock(torch.nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, hidden_channels=64, mesh_type='body'):
        super(GraphResBlock, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.lin1 = GraphLinear(in_channels, hidden_channels)
        self.conv = GraphConvolution(hidden_channels,hidden_channels, mesh_type)
        ...
        self.norm1 = BertLayerNorm(hidden_channels)
        self.norm2 = BertLayerNorm(hidden_channels)
